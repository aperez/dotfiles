    ...
    (use-package base16-theme
      ...
      (custom-theme-set-faces 'base16-default-dark
        `(linum ((t (:background ,(plist-get base16-default-dark-colors :base00)
                     :foreground ,(plist-get base16-default-dark-colors :base03)))))
...
* Packages
** Delight
   [[https://savannah.nongnu.org/projects/delight][=delight=]] controls the way minor modes appear on the mode line:
   #+BEGIN_SRC emacs-lisp
     (use-package delight
       :ensure t)
   #+END_SRC
...
** Counsel and Swiper
   [[https://github.com/abo-abo/swiper][=counsel= and =swiper=]] enable better completion mechanisms for the mini-buffer
   and for search, respectively:
   #+BEGIN_SRC emacs-lisp
     (use-package counsel
       :ensure t
...
** Avy
   [[https://github.com/abo-abo/avy][=avy=]] allows you to jump around visible text:
   #+BEGIN_SRC emacs-lisp
      (use-package avy
        :ensure t
...
** Expand-region
   [[https://github.com/magnars/expand-region.el][=expand-region=]] increasingly expands selected text by semantic units:
   #+BEGIN_SRC emacs-lisp
...
** Undo-tree
   [[https://melpa.org/#/undo-tree][=undo-tree=]] allows you to recover any past state of a buffer by visually
...
** Projectile
   [[https://github.com/bbatsov/projectile][=projectile=]] makes navigating within projects really easy:
   #+BEGIN_SRC emacs-lisp
...
** Auctex
   Enable [[https://www.gnu.org/software/auctex/][=auctex=]] package for editing LaTeX files:
   #+BEGIN_SRC emacs-lisp
      (use-package tex
        :defer t
        :ensure auctex
...
** Popwin
   [[https://github.com/m2ym/popwin-el][=popwin=]] enables closing popup windows via =C-g=:
   #+BEGIN_SRC emacs-lisp
     (use-package popwin
       :ensure t
       :config
